  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between w-full text-xs mt-3">
        <div className="flex flex-col items-start">
          <div className="text-foreground/60 text-[10px] uppercase tracking-wide">Hold Time</div>
          <div className="font-semibold">1:14</div>
        </div>
        <div className="flex flex-col items-end">
          <div className="text-foreground/60 text-[10px] uppercase tracking-wide">ACW</div>
